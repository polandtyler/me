...
alias reset="git add -A && git reset --hard HEAD && git prune"
alias stash="git add -A && git stash"
alias pull="fetch && git pull"
alias prull="prune && pull"
alias main="stash && git checkout main & prull"
...
function disappointed() { echo -n " ಠ_ಠ " | pbcopy; }
function flip() { echo -n "（╯°□°）╯ ┻━┻" | pbcopy; }
